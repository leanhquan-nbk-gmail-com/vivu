...
# load the image
first_read_image = cv2.imread("342.png")#rash3
...
#print(len(addition_of_row_numbers_having_dark_pixels_in_each_column))
...
for x in range(0,columns):
    ...
    for y in range(0,rows):
        ...
        if res[0] > mean_color[0] * 0.5 and res[1] > mean_color[1] * 0.5 and res[2] > mean_color[2] * 0.5:    
            ...
            print ("y:",y,end = " ")
            print ("x:",x,end = " ")
            print("addition :",addition_of_row_numbers_having_dark_pixels_in_each_column[x],end = " ")
            print("add :",addition_of_row_numbers_having_dark_pixels_in_each_column,end = " ")
            print ("|") """
    ...
    if num > 2:
        ...
        """ time.sleep(0.1)
        print ("number ",numbers_of_dark_pixels_in_each_column[x],end = " ")
        print ("x : ",x)
        print ("ad :",addition_of_row_numbers_having_dark_pixels_in_each_column[x])
        print ("chia :",average_of_row_numbers_having_dark_pixels_in_each_column[x])
        #print ("chi :",average_of_row_numbers_having_dark_pixels_in_each_column)
        print ("|") """
...
if count > 0: #if there are values greater than 0 in nums array 
    ...
    """ print("aver:",average_dark_pixels) 
    print("count:",count) """ 
    for x in range(0,columns):
        if numbers_of_dark_pixels_in_each_column[x] > average_dark_pixels + 15: #if nums(column number) is greater than ((average times the num has been greater than 0) + 15)
            #print("number:",numbers_of_dark_pixels_in_each_column[x]) 
...
if x_min >= 0: #if minx is greater than or equal to 0 (ie. respective index of nums array saved above is higher than 0)
    ...
    """ print("xmax2>:",x_max_2)
    print(len(average_of_row_numbers_having_dark_pixels_in_each_column) - 1)
    print(average_of_row_numbers_having_dark_pixels_in_each_column) """
    ...
    print("xmin2",x_min_2)
    print("xmax2",x_max_2)
    print("average_of_row_numbers_having_dark_max:",average_of_row_numbers_having_dark_pixels_in_each_column[x_max_2])
    print("average_of_row_numbers_having_dark_min:",average_of_row_numbers_having_dark_pixels_in_each_column[x_min_2]) """
...
def UserName():
    ...
    print (answer) 
    lbl.config(text='User expected:'+answer)
